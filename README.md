...
- With that information, you can start writing the **site's schema**. Specify in `data/schema.yaml` the types of content items you will have and the fields/attributes for each one of them. _Editorial_ will help authors edit the data in `data/data.json` following the schema you define.
